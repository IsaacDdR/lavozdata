<template>
  <section class="text-gray-600 body-font relative">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-12 mt-6">
        <h1
        ...
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-900">
          Quieres preguntar o comentar algo, deja tus datos o mándanos un
          mensaje.
        </p>
      </div>
      <div class="lg:w-1/2 md:w-2/3 mx-auto">
        <div class="flex flex-wrap -m-2">
          ...
          <div
            class="p-2 w-full pt-3 mt-8 border-t border-gray-200 text-center"
          >
            <a class="text-gray-900">hola@lavozuniversal.com</a>
            <br />
            <span class="inline-flex mt-4">
              ...
              <a class="ml-4 text-gray-900 hover:text-blue-600">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
