	...
	<div class="container pt-22 md:pt-5 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
     ...
     <div class="container w-full text-center mx-auto pb-24 lg:pb-0 fade-in pt-8">
      <div class="container w-full ">
        <p class="mx-auto text-blue-400 font-bold pb-8 lg:pb-6 text-center fade-in">Síguenos en redes</p>
      </div>
    
      <div class="container w-full">

          <a class="inline-block text-blue-300 no-underline hover:text-indigo-800 hover:text-underline text-center" data-tippy-content="#facebook_id" href="https://www.facebook.com/sharer/sharer.php?u=#">
          ...
          <a class="inline-block text-blue-300 no-underline hover:text-indigo-800 hover:text-underline text-center" data-tippy-content="@twitter_handle" href="https://twitter.com/intent/tweet?url=#">
