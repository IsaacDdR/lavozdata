<template>
  <div
    class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20"
  >
    <div class="grid gap-10 lg:grid-row lg:w-1/2 mx-auto mt-12 md:mt-14">
      <div class="lg:pr-10">
        <h5
          class="md:tracking-wider text-center mb-4 text-5xl font-extrabold leading-none text-blue-600"
        >
          Más de nosotros
        </h5>
        <p class="text-justify mb-6 text-gray-900">
      ...
      <div>
        <img
          class="object-cover lg:w-full mx-auto h-56 rounded shadow-lg sm:h-96"
          src="https://res.cloudinary.com/duruqkfg4/image/upload/v1621125031/loc_folrjs.jpg"
          alt=""
        />
      </div>
    </div>
